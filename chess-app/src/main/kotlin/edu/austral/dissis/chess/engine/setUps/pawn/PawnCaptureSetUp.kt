...
class PawnCaptureSetUp {
    ...
    fun setUp(): Board {
        ...
        val bPiece = Piece("2 3", Color.BLACK, listOf(PawnMovesComposite(), MoveLimitation(1,1, DoublePawnMove())), PieceType.PAWN )
        board = board.putPieceAt(Position(2, 3), bPiece)
        return board
    }
}